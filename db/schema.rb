...
ActiveRecord::Schema.define(version: 2019_03_28_214107) do
  ...
  create_table "product_status_codes", force: :cascade do |t|
    t.string "name"
    t.text "description"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "products", force: :cascade do |t|
    ...
    t.text "description"
    t.integer "price"
    t.bigint "product_status_code_id"
    t.bigint "product_category_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "image"
    t.index ["product_category_id"], name: "index_products_on_product_category_id"
    t.index ["product_status_code_id"], name: "index_products_on_product_status_code_id"
  end
