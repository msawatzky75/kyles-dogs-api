...
class CartItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cart_item" do
    assert_difference('CartItem.count') do
      post cart_items_url, params: { cart_item: { product: @cart_item.product, user: @cart_item.user } }, as: :json
    end
  ...
  test "should update cart_item" do
    patch cart_item_url(@cart_item), params: { cart_item: { product: @cart_item.product, user: @cart_item.user } }, as: :json
    assert_response 200
  end
